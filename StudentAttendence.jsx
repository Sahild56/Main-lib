  ...
  return (
    ...
    <Link to='/' ><button onClick={handleLogout} style={{background:'rgba(113, 99, 186, 255)', width:'80px',height:'40px',borderRadius:'10px',position:'relative', left:'-150px' ,textAlign:'center',top:'-7px', fontSize:'20px' ,color:'black' }}>Logout</button></Link>
        ...
        <div className="details">
         <h1 style={{fontSize:'25px',color:'rgba(113,99,186,255)',position:'relative',left:'-100px'}}>Attendence</h1>
        </div>

        <div style={{position:'relative', top:'-330px',width:'80%',left:'50px'}}>
        <table >
                <thead>
                    <tr>
                        <th>Student Name</th>
                        <th>Student Contact</th>
                        <th>Student Login Date</th>
                        <th>Student Login Time</th>
                        <th>Student Logout Date</th>
                        <th>Student Logout Time</th>
                    </tr>
                </thead>
                <tbody>
                <tr>
                        ...
                        <td>{userData.loginDate}</td>
                        <td>{userData.loginTime}</td>
                        <td>{userData.logoutDate}</td>
                        <td>{userData.logoutTime}</td>
                    </tr>
                </tbody>
        </table>
        </div>
