  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        console.log("Bhaiii here ojs your emai++++++++++++++++", userEmail)
      } catch (error) {
    ...
    <div  >
      ...
      <div className="main">
        <div className="topbar">
          ...
          <Link to='/' ><button onClick={handleLogout} style={{background:'rgba(113, 99, 186, 255)', width:'80px',height:'40px',borderRadius:'10px',position:'relative', left:'-200px' ,textAlign:'center',top:'-7px', fontSize:'20px' ,color:'black' }}>Logout</button></Link>
        </div>
        ...
        <div className="details">
          <div className="recentOrders">
            ...
            <div className="studtable" style={{height: '300px', overflowY: 'scroll',width:'150%',position:'relative',left:'-70px'}}>
            <table>
                <thead>
                    <tr>
                        <th>Name</th>
