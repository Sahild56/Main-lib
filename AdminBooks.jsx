        ...
        <div className="details" style={{width:'100%'}}>
          <div className="recentOrders">
            <div className="cardHeader">
              ...
              <Link to="/admin/addbooks" className="btn" style={{background:"rgba(113, 99, 186, 255)",width:'15%',fontSize:"20px",position:'relative',left:'10%'}}>
                Add Books
              </Link>
            </div>
         <br />
         <br />
            <div className="booktable" style={{ height: '300px', overflowY: 'scroll',width:"130%",position:'relative',left:'-15%',top:'-20px' }}>
            <table>
